...
# Goal: Learn deterministic functions f_i: X_i = f_i(Parents(X_i), eps_i).
# During training, eps_i are latent residuals (assumed ~ N(0, sigma^2)).
...
def train_scm(X, y, parents_dict, train_idx, test_idx, output_dir):
    ...
    print(f"[SCM Phase 1] {output_dir.split('/')[-1]} metrics:")
